...
var UserCoin_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "user_groth.proto",
}

const (
	UserGrade_ListGrades_FullMethodName         = "/UserGrowth.UserGrade/ListGrades"
	UserGrade_ListGradePrivilege_FullMethodName = "/UserGrowth.UserGrade/ListGradePrivilege"
...
type UserGradeClient interface {
	...
	//获取等级的特权列表
	ListGradePrivilege(ctx context.Context, in *ListGradePrivilegeRequest, opts ...grpc.CallOption) (*ListGradePrivilegeReply, error)
	//检查用户是否拥有某个产品特权
...
func (c *userGradeClient) ListGradePrivilege(ctx context.Context, in *ListGradePrivilegeRequest, opts ...grpc.CallOption) (*ListGradePrivilegeReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListGradePrivilegeReply)
	err := c.cc.Invoke(ctx, UserGrade_ListGradePrivilege_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserGradeServer interface {
	...
	//获取等级的特权列表
	ListGradePrivilege(context.Context, *ListGradePrivilegeRequest) (*ListGradePrivilegeReply, error)
	//检查用户是否拥有某个产品特权
...
func (UnimplementedUserGradeServer) ListGradePrivilege(context.Context, *ListGradePrivilegeRequest) (*ListGradePrivilegeReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListGradePrivilege not implemented")
}
...
func _UserGrade_ListGradePrivilege_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListGradePrivilegeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserGradeServer).ListGradePrivilege(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserGrade_ListGradePrivilege_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserGradeServer).ListGradePrivilege(ctx, req.(*ListGradePrivilegeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserGrade_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListGradePrivilege",
			Handler:    _UserGrade_ListGradePrivilege_Handler,
		},
		{
