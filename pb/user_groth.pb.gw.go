...
func request_UserCoin_UserCoinDetails_0(ctx context.Context, marshaler runtime.Marshaler, client UserCoinClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UserCoinDetailsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UserCoinDetails(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UserCoin_UserCoinDetails_0(ctx context.Context, marshaler runtime.Marshaler, server UserCoinServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UserCoinDetailsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UserCoinDetails(ctx, &protoReq)
	return msg, metadata, err
...
func request_UserGrade_ListGradePrivilege_0(ctx context.Context, marshaler runtime.Marshaler, client UserGradeClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListGradePrivilegeRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ListGradePrivilege(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UserGrade_ListGradePrivilege_0(ctx context.Context, marshaler runtime.Marshaler, server UserGradeServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListGradePrivilegeRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListGradePrivilege(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterUserCoinHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserCoinServer) error {
	...
	mux.Handle("GET", pattern_UserCoin_ListTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/UserGrowth.UserCoin/ListTasks", runtime.WithHTTPPathPattern("/v1/listtasks"))
		if err != nil {
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/UserGrowth.UserCoin/UserCoinDetails", runtime.WithHTTPPathPattern("/UserGrowth.UserCoin/UserCoinDetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UserCoin_UserCoinDetails_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UserCoin_UserCoinDetails_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/UserGrowth.UserCoin/UserCoinChange", runtime.WithHTTPPathPattern("/v1/changeCoin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUserGradeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserGradeServer) error {
	...
	mux.Handle("GET", pattern_UserGrade_ListGrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/UserGrowth.UserGrade/ListGrades", runtime.WithHTTPPathPattern("/v1/ListGrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_ListGradePrivilege_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/UserGrowth.UserGrade/ListGradePrivilege", runtime.WithHTTPPathPattern("/UserGrowth.UserGrade/ListGradePrivilege"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UserGrade_ListGradePrivilege_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UserGrade_ListGradePrivilege_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUserCoinHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserCoinClient) error {
	...
	mux.Handle("GET", pattern_UserCoin_ListTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/UserGrowth.UserCoin/ListTasks", runtime.WithHTTPPathPattern("/v1/listtasks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/UserGrowth.UserCoin/UserCoinDetails", runtime.WithHTTPPathPattern("/UserGrowth.UserCoin/UserCoinDetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UserCoin_UserCoinDetails_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/UserGrowth.UserCoin/UserCoinChange", runtime.WithHTTPPathPattern("/v1/changeCoin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UserCoin_ListTasks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "listtasks"}, ""))
	...
	pattern_UserCoin_UserCoinDetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"UserGrowth.UserCoin", "UserCoinDetails"}, ""))

	pattern_UserCoin_UserCoinChange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "changeCoin"}, ""))
)
...
var (
	...
	forward_UserCoin_UserCoinDetails_0 = runtime.ForwardResponseMessage
...
func RegisterUserGradeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserGradeClient) error {
	...
	mux.Handle("GET", pattern_UserGrade_ListGrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/UserGrowth.UserGrade/ListGrades", runtime.WithHTTPPathPattern("/v1/ListGrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_ListGradePrivilege_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/UserGrowth.UserGrade/ListGradePrivilege", runtime.WithHTTPPathPattern("/UserGrowth.UserGrade/ListGradePrivilege"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UserGrade_ListGradePrivilege_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UserGrade_ListGrades_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "ListGrades"}, ""))

	pattern_UserGrade_ListGradePrivilege_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"UserGrowth.UserGrade", "ListGradePrivilege"}, ""))
...
var (
	...
	forward_UserGrade_ListGradePrivilege_0 = runtime.ForwardResponseMessage
